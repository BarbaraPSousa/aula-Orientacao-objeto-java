...
public class Programa {
	...
	public static void main(String[] args) {
		...
		List<String > list = new ArrayList<>(); /*Não aceita tipos premitivos só replecles*/
		...
		/*Adicionando coisas na Lista*/
		 ...
		 // list.remove(1); // pode se usar o nome ou a posição
		  ...
		  /*Entratar a Posição de um Elemento*/
		  									   /*Fun.*/	   /*Nome*/
		  System.out.println("Index of Bob: " + list.indexOf("Bob"));
		  
		  /*Procurando elemento que não esta na lista*/
		                                        /*Fun.*/	 /*Nome*/
		...
		/*Variavel*/ /*Nome V*/ /*comando */  /*filtro*/                    /*funcao*/    /*retorna null se não tiver o p´redicado*/
		  String      name =    list.stream().filter(x-> x.charAt(0) == 'A').findFirst().orElse(null);
		  System.out.println(name);
		  
		  name =    list.stream().filter(x-> x.charAt(0) == 'j').findFirst().orElse(null);
		  System.out.println(name); // casos que não tenha na lista
